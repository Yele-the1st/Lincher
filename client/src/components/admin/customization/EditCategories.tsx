  ...
  return (
    <div className=" mt-[80px] sm:ml-64  bg-transparent">
      {loading ? (
        ...
        <div className=" text-gray-900 dark:text-white py-10 flex flex-col text-center max-w-max mx-auto my-4 px-8">
          <div className=" bg-accent dark:bg-background-darkHover rounded-[1rem] p-10">
